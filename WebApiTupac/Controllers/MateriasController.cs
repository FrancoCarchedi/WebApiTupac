...
namespace WebApiTupac.Controllers
{
    ...
    public class MateriasController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Insert([FromBody] MateriaCreacionDTO materiaCreacionDTO)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult> Update([FromBody] MateriaCreacionDTO materiaCreacionDTO, int id)
        {
            var materia = await _materiasRepository.GetById(id);
            ...
            if (materiaCreacionDTO.CarreraId == materia.CarreraId)
            {
                materia.Nombre = materiaCreacionDTO.Nombre;
                materia.CarreraId = materiaCreacionDTO.CarreraId;
